...

{
  ...
  workloads: {
    ...
    spegel: {
      ...
      stages: {
        mirror: d.fn("The Spegel DaemonSet and its Services. namespace MUST match the deploy namespace (the peer-bootstrap DNS name embeds it). containerdSock/containerdContentPath/containerdRegistryConfigPath point at the node's containerd; registryNodePort is where the kubelet reaches the local mirror.", [
          ...
          d.arg('registryNodePort', d.T.int, default=30020),
          ...
          d.arg('resources', d.T.object, default={ requests: { cpu: '50m', memory: '128Mi' }, limits: { memory: '128Mi' } }),
          d.arg('tolerations', d.T.array, default=[{ operator: 'Exists' }]),
          d.arg('nodeSelector', d.T.object, default={}),
