  ...
  workloads: {
    ...
    k8up: {
      ...
      stages: {
        ...
        restore: d.fn('A Restore: the half that proves the other half. Runs once when applied — into a claim (recovery) or to object storage as a tarball (inspection). runnable=false stages it, so the manifest lands and a person starts it deliberately.', [
          d.arg('name', d.T.string, default='restore'),
          ...
          d.arg('runnable', d.T.bool, default=true),
          d.arg('resources', d.T.object),
          d.arg('podSecurityContext', d.T.object),
          d.arg('backend', d.T.object, default={}),
