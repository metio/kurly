...

{
  ...
  workloads: {
    ...
    linkwarden: {
      ...
      requires: { database: true, objectStorage: 'optional' },
      stages: {
    ...
    teable: {
      ...
      requires: { database: true, cache: true, objectStorage: 'optional' },
      stages: {
    ...
    ghostfolio: {
      ...
      requires: { database: true, cache: true },
      stages: {
    ...
    thanos: {
      ...
      requires: { cache: true, objectStorage: 'required' },
      stages: {
