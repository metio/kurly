...
local stageImports = {
  ...
  'docs/backend': import 'github.com/metio/kurly/workloads/docs/backend.libsonnet',
  'docs/frontend': import 'github.com/metio/kurly/workloads/docs/frontend.libsonnet',
  'docs/y-provider': import 'github.com/metio/kurly/workloads/docs/y-provider.libsonnet',
  ...
  'pmm/server': import 'github.com/metio/kurly/workloads/pmm/server.libsonnet',
  ...
  'authorizer/server': import 'github.com/metio/kurly/workloads/authorizer/server.libsonnet',
  'questdb/server': import 'github.com/metio/kurly/workloads/questdb/server.libsonnet',
  'oxicloud/server': import 'github.com/metio/kurly/workloads/oxicloud/server.libsonnet',
  ...
  'artalk/server': import 'github.com/metio/kurly/workloads/artalk/server.libsonnet',
  'pigallery-2/server': import 'github.com/metio/kurly/workloads/pigallery-2/server.libsonnet',
  'static-web-server/server': import 'github.com/metio/kurly/workloads/static-web-server/server.libsonnet',
  'traduora/server': import 'github.com/metio/kurly/workloads/traduora/server.libsonnet',
  'ferron/server': import 'github.com/metio/kurly/workloads/ferron/server.libsonnet',
  'fusio/server': import 'github.com/metio/kurly/workloads/fusio/server.libsonnet',
  'mainsail/server': import 'github.com/metio/kurly/workloads/mainsail/server.libsonnet',
  'pelican-panel/server': import 'github.com/metio/kurly/workloads/pelican-panel/server.libsonnet',
  'anubis/server': import 'github.com/metio/kurly/workloads/anubis/server.libsonnet',
  'caddy/server': import 'github.com/metio/kurly/workloads/caddy/server.libsonnet',
  'librechat/server': import 'github.com/metio/kurly/workloads/librechat/server.libsonnet',
  'nginx/server': import 'github.com/metio/kurly/workloads/nginx/server.libsonnet',
  'stash/server': import 'github.com/metio/kurly/workloads/stash/server.libsonnet',
  'adventurelog/server': import 'github.com/metio/kurly/workloads/adventurelog/server.libsonnet',
  'chibisafe/frontend': import 'github.com/metio/kurly/workloads/chibisafe/frontend.libsonnet',
  'chibisafe/proxy': import 'github.com/metio/kurly/workloads/chibisafe/proxy.libsonnet',
  ...
  'algernon/server': import 'github.com/metio/kurly/workloads/algernon/server.libsonnet',
  'chronoframe/server': import 'github.com/metio/kurly/workloads/chronoframe/server.libsonnet',
  'directory-lister/server': import 'github.com/metio/kurly/workloads/directory-lister/server.libsonnet',
  'ech0/server': import 'github.com/metio/kurly/workloads/ech0/server.libsonnet',
  'pdfding/server': import 'github.com/metio/kurly/workloads/pdfding/server.libsonnet',
  'vince/server': import 'github.com/metio/kurly/workloads/vince/server.libsonnet',
  'bracket/server': import 'github.com/metio/kurly/workloads/bracket/server.libsonnet',
  'damselfly/server': import 'github.com/metio/kurly/workloads/damselfly/server.libsonnet',
  'fluidd/server': import 'github.com/metio/kurly/workloads/fluidd/server.libsonnet',
  'jotty/server': import 'github.com/metio/kurly/workloads/jotty/server.libsonnet',
  'part-db/server': import 'github.com/metio/kurly/workloads/part-db/server.libsonnet',
  'trip/server': import 'github.com/metio/kurly/workloads/trip/server.libsonnet',
  'apache-solr/server': import 'github.com/metio/kurly/workloads/apache-solr/server.libsonnet',
  'atomic-server/server': import 'github.com/metio/kurly/workloads/atomic-server/server.libsonnet',
  ...
  'bifrost/gateway': import '../workloads/bifrost/gateway.libsonnet',
  'bunkerm/server': import '../workloads/bunkerm/server.libsonnet',
  'cloudflare-tunnel-ingress-controller/controller': import '../workloads/cloudflare-tunnel-ingress-controller/controller.libsonnet',
  'defguard/core': import '../workloads/defguard/core.libsonnet',
  'gitness/server': import '../workloads/gitness/server.libsonnet',
  'hypermind/server': import '../workloads/hypermind/server.libsonnet',
  'metamcp/server': import '../workloads/metamcp/server.libsonnet',
  'rssbox/server': import '../workloads/rssbox/server.libsonnet',
  'rustfs/server': import '../workloads/rustfs/server.libsonnet',
  'shkeeper/server': import '../workloads/shkeeper/server.libsonnet',
  'sglang/server': import '../workloads/sglang/server.libsonnet',
  'varnish/cache': import '../workloads/varnish/cache.libsonnet',
  'triton-inference-server/server': import '../workloads/triton-inference-server/server.libsonnet',
  'gpustack/server': import '../workloads/gpustack/server.libsonnet',
  ...
  'budget-board/client': import 'github.com/metio/kurly/workloads/budget-board/client.libsonnet',
  'budget-board/server': import 'github.com/metio/kurly/workloads/budget-board/server.libsonnet',
  'karaoke-eternal/server': import 'github.com/metio/kurly/workloads/karaoke-eternal/server.libsonnet',
  'lancache/server': import 'github.com/metio/kurly/workloads/lancache/server.libsonnet',
  'librebooking/server': import 'github.com/metio/kurly/workloads/librebooking/server.libsonnet',
  'safebucket/server': import 'github.com/metio/kurly/workloads/safebucket/server.libsonnet',
  'tiny-tiny-rss/server': import 'github.com/metio/kurly/workloads/tiny-tiny-rss/server.libsonnet',
  'discount-bandit/server': import 'github.com/metio/kurly/workloads/discount-bandit/server.libsonnet',
  'jelu/server': import 'github.com/metio/kurly/workloads/jelu/server.libsonnet',
  'mafl/server': import 'github.com/metio/kurly/workloads/mafl/server.libsonnet',
  'note-mark/server': import 'github.com/metio/kurly/workloads/note-mark/server.libsonnet',
  'atheos/server': import 'github.com/metio/kurly/workloads/atheos/server.libsonnet',
  'drop/server': import 'github.com/metio/kurly/workloads/drop/server.libsonnet',
  'enigma-12-bbs/server': import 'github.com/metio/kurly/workloads/enigma-12-bbs/server.libsonnet',
  'mayan-edms/server': import 'github.com/metio/kurly/workloads/mayan-edms/server.libsonnet',
  'reaparr/server': import 'github.com/metio/kurly/workloads/reaparr/server.libsonnet',
  'manage-my-damn-life/server': import 'github.com/metio/kurly/workloads/manage-my-damn-life/server.libsonnet',
  'medama-analytics/server': import 'github.com/metio/kurly/workloads/medama-analytics/server.libsonnet',
  'quickshare/server': import 'github.com/metio/kurly/workloads/quickshare/server.libsonnet',
  'wiki-go/server': import 'github.com/metio/kurly/workloads/wiki-go/server.libsonnet',
  ...
  'vinyl-cache/server': import 'github.com/metio/kurly/workloads/vinyl-cache/server.libsonnet',
  ...
  'redash/server': import 'github.com/metio/kurly/workloads/redash/server.libsonnet',
  'redash/scheduler': import 'github.com/metio/kurly/workloads/redash/scheduler.libsonnet',
  'redash/worker': import 'github.com/metio/kurly/workloads/redash/worker.libsonnet',
  'harbor/core': import 'github.com/metio/kurly/workloads/harbor/core.libsonnet',
  'harbor/jobservice': import 'github.com/metio/kurly/workloads/harbor/jobservice.libsonnet',
  'harbor/portal': import 'github.com/metio/kurly/workloads/harbor/portal.libsonnet',
  'harbor/registry': import 'github.com/metio/kurly/workloads/harbor/registry.libsonnet',
  'druid/broker': import 'github.com/metio/kurly/workloads/druid/broker.libsonnet',
  'druid/coordinator': import 'github.com/metio/kurly/workloads/druid/coordinator.libsonnet',
  'druid/historical': import 'github.com/metio/kurly/workloads/druid/historical.libsonnet',
  'druid/middle-manager': import 'github.com/metio/kurly/workloads/druid/middle-manager.libsonnet',
  'druid/router': import 'github.com/metio/kurly/workloads/druid/router.libsonnet',
  'docker-mailserver/server': import 'github.com/metio/kurly/workloads/docker-mailserver/server.libsonnet',
  'coder/server': import 'github.com/metio/kurly/workloads/coder/server.libsonnet',
  'apache-airflow/server': import 'github.com/metio/kurly/workloads/apache-airflow/server.libsonnet',
  'localai/server': import 'github.com/metio/kurly/workloads/localai/server.libsonnet',
  'mongooseim/server': import 'github.com/metio/kurly/workloads/mongooseim/server.libsonnet',
  'wildduck/server': import 'github.com/metio/kurly/workloads/wildduck/server.libsonnet',
  'postal/server': import 'github.com/metio/kurly/workloads/postal/server.libsonnet',
  'postal/smtp': import 'github.com/metio/kurly/workloads/postal/smtp.libsonnet',
  'postal/worker': import 'github.com/metio/kurly/workloads/postal/worker.libsonnet',
  'khoj/server': import 'github.com/metio/kurly/workloads/khoj/server.libsonnet',
  'zenko-cloudserver/server': import 'github.com/metio/kurly/workloads/zenko-cloudserver/server.libsonnet',
  'tuwunel/server': import 'github.com/metio/kurly/workloads/tuwunel/server.libsonnet',
...
// What the stage actually cost to start, measured while an e2e scenario booted
// it rather than declared by whoever wrote the stage.
//
// MEASURED ON A KIND CLUSTER ON A DEVELOPER MACHINE, so it is not a production
// sizing guide and a consumer must not present it as one. What carries over to
// real hardware is the shape: which workloads need far more memory to start than
// to run, and which take minutes rather than seconds before they serve.
//
// `peakStartup` and `steady` are SEPARATE, because most resource defaults are
// wrong in the same direction — sized for the migration or sized for the service,
// never both. A single number would hide exactly the gap a consumer needs to see
// to set a request and a limit that are each right.
//
// Anchored to the digest it was taken on and dropped when the pin moves past it,
// like the signature claim: an image bump can change what a workload needs, and
// carrying yesterday's figure onto today's bits would publish a guess in the one
// field whose whole claim is that somebody measured it.
local measurementOf(workload, stage, pinnedDigest) =
  local entry = std.get(measurements, workload + '/' + stage, null);
  if entry == null then null
  else if std.get(entry, 'digest', null) == null then null
  else if pinnedDigest == null || entry.digest != pinnedDigest then null
  else {
    secondsToReady: entry.secondsToReady,
    peakStartupBytes: entry.peakStartupBytes,
    steadyBytes: entry.steadyBytes,
  };
...
local workloadEntries =
  ...
  // — an absent entry means nobody has measured that stage yet, which is a true
  // and common answer.
  assert std.all([std.member(stageKeys, key) for key in std.objectFields(measurements)]) :
         'measurements.gen.libsonnet names a stage that does not exist — rerun gen-measurements';
    ...
    + {
      ...
      stages: [
        ...
        + (
          ...
          + { measured: measurementOf(workload, stage, pinned) }
