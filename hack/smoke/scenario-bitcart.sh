...
# e2e for the bitcart workload: provision its declared dependencies (a throwaway
...
ns="$(kurly::namespace_unique kurly-bitcart)"
kurly::namespace "$ns"

kurly::postgres "$ns" bitcart-db-rw bitcart bitcart
