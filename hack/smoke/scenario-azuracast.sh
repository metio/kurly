...
# e2e for the azuracast workload: provision its declared dependencies (a throwaway
...
ns="$(kurly::namespace_unique kurly-azuracast)"
kurly::namespace "$ns"

kurly::mysql "$ns" azuracast-db azuracast azuracast
