...
|---|---|---|
| `name` | `otel-collector` | |
| `image` | `docker.io/otel/opentelemetry-collector-contrib:0.157.0` | the contrib distribution (all receivers/exporters) |
...
spec: { interval: 12h, url: oci://ghcr.io/metio/kurly/workloads/otel-collector, ref: { tag: 2026.7.29 } }
---
