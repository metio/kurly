...
kind: OCIRepository
metadata: { name: kurly, namespace: netbootxyz }
spec: { interval: 12h, url: oci://ghcr.io/metio/kurly, ref: { tag: 2026.7.29 } }
---
apiVersion: source.toolkit.fluxcd.io/v1
kind: OCIRepository
metadata: { name: kurly-netbootxyz, namespace: netbootxyz }
spec: { interval: 12h, url: oci://ghcr.io/metio/kurly/workloads/netbootxyz, ref: { tag: 2026.7.29 } }
---
...
kind: JsonnetLibrary
metadata: { name: kurly-netbootxyz, namespace: netbootxyz }
spec: { sourceRef: { kind: OCIRepository, name: kurly-netbootxyz } }
---
apiVersion: jaas.metio.wtf/v1
kind: JsonnetSnippet
metadata: { name: netbootxyz, namespace: netbootxyz }
spec:
  serviceAccountName: netbootxyz-renderer
  files:
    main.jsonnet: |
      local kurly = import 'github.com/metio/kurly/main.libsonnet';
      local server = import 'github.com/metio/kurly/workloads/netbootxyz/server.libsonnet';
      // Compose your exposure and any + features here, then render.
      kurly.list(server())
  libraries:
    - { kind: JsonnetLibrary, name: kurly, importPath: github.com/metio/kurly }
    - { kind: JsonnetLibrary, name: kurly-netbootxyz, importPath: github.com/metio/kurly/workloads/netbootxyz }
```
...
metadata: { name: netbootxyz, namespace: netbootxyz }
spec:
  serviceAccountName: netbootxyz-deployer
  ...
  stages:
    - name: server
      ...
      readyChecks:
        checks:
          - { apiVersion: apps/v1, kind: Deployment, name: netbootxyz }
```
