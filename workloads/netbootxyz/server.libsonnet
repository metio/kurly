...
// netbootxyz — a a netboot.xyz server (a self-hosted network-boot menu and asset server for PXE-booting installers and tools). A plain composable kurly.http workload on the LinuxServer.io
...
function(
  name='netbootxyz',
  image='lscr.io/linuxserver/netbootxyz:0.7.5',
  storageSize='5Gi',
  storageClass=null,
  puid=1000,
  pgid=1000,
