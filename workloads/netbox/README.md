...
|---|---|---|
| `name` | `netbox` | |
| `image` | `docker.io/netboxcommunity/netbox:v4.6.10` | |
...
|---|---|---|
| `name` | `netbox-worker` | |
| `image` | `docker.io/netboxcommunity/netbox:v4.6.10` | same image as the server |
...
spec: { interval: 12h, url: oci://ghcr.io/metio/kurly/workloads/netbox, ref: { tag: 2026.7.29 } }
---
