...
// mylar3 — a a Mylar3 server (a self-hosted comic-book (CBR/CBZ) downloader and library manager). A plain composable kurly.http workload on the LinuxServer.io
...
//   kurly.list(mylar3())
//
// Serves the web app on :8090 — compose an exposure onto it.
//
