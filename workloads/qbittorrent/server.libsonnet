...
// qbittorrent — a a qBittorrent server (a feature-rich, self-hosted BitTorrent client with a web UI). A plain composable kurly.http workload on the LinuxServer.io
