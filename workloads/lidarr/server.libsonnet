...
// lidarr — a Lidarr server (a music collection manager for Usenet and BitTorrent users). A plain composable kurly.http workload on the
...
//   kurly.list(lidarr())
//
// Serves the web app and API on :8686 — compose an exposure onto it.
//
// MEDIA & DOWNLOADS: Lidarr works against your media library and download-client
// directories. Mount them and point Lidarr at them in its settings; compose the extra
