...
// prestashop — a A PrestaShop server (a self-hosted, open-source e-commerce platform for building online stores (backed by MySQL)). A plain composable kurly.http workload on the official image,
...
function(
  name='prestashop',
  image='docker.io/prestashop/prestashop:9.1',
  storageSize='10Gi',
  storageClass=null,
