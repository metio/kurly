...
| `image` | `docker.io/valkey/valkey:9.1.1` | any Redis-compatible server built the same way |
...
spec: { interval: 12h, url: oci://ghcr.io/metio/kurly/workloads/valkey, ref: { tag: 2026.7.29 } }
---
