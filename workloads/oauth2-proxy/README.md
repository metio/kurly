...
**rendered** — this workload renders and validates against the Kubernetes schemas with its defaults. Delivered end to end through Flux, JaaS and stageset-controller on 2026-07-31, and observed rolling out.
...
spec: { interval: 12h, url: oci://ghcr.io/metio/kurly/workloads/oauth2-proxy, ref: { tag: 2026.7.29 } }
---
