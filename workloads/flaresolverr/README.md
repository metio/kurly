...
kind: OCIRepository
metadata: { name: kurly, namespace: flaresolverr }
spec: { interval: 12h, url: oci://ghcr.io/metio/kurly, ref: { tag: 2026.7.29 } }
---
apiVersion: source.toolkit.fluxcd.io/v1
kind: OCIRepository
metadata: { name: kurly-flaresolverr, namespace: flaresolverr }
spec: { interval: 12h, url: oci://ghcr.io/metio/kurly/workloads/flaresolverr, ref: { tag: 2026.7.29 } }
---
...
kind: JsonnetLibrary
metadata: { name: kurly-flaresolverr, namespace: flaresolverr }
spec: { sourceRef: { kind: OCIRepository, name: kurly-flaresolverr } }
---
apiVersion: jaas.metio.wtf/v1
kind: JsonnetSnippet
metadata: { name: flaresolverr, namespace: flaresolverr }
spec:
  serviceAccountName: flaresolverr-renderer
  files:
    main.jsonnet: |
      local kurly = import 'github.com/metio/kurly/main.libsonnet';
      local server = import 'github.com/metio/kurly/workloads/flaresolverr/server.libsonnet';
      // Compose your exposure and any + features here, then render.
      kurly.list(server())
  libraries:
    - { kind: JsonnetLibrary, name: kurly, importPath: github.com/metio/kurly }
    - { kind: JsonnetLibrary, name: kurly-flaresolverr, importPath: github.com/metio/kurly/workloads/flaresolverr }
```
...
metadata: { name: flaresolverr, namespace: flaresolverr }
spec:
  serviceAccountName: flaresolverr-deployer
  ...
  stages:
    - name: server
      ...
      readyChecks:
        checks:
          - { apiVersion: apps/v1, kind: Deployment, name: flaresolverr }
```
