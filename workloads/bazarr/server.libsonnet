...
// bazarr — a Bazarr server (a companion to Sonarr and Radarr that manages and downloads subtitles). A plain composable kurly.http workload on the
...
//   kurly.list(bazarr())
//
// Serves the web app and API on :6767 — compose an exposure onto it.
//
// MEDIA & DOWNLOADS: Bazarr works against your media library and download-client
// directories. Mount them and point Bazarr at them in its settings; compose the extra
