...
kurly.list([
  cnpg(name='fider-db', database='fider'),
  fider(baseUrl='https://feedback.example.com'),
])
```
...
spec: { interval: 12h, url: oci://ghcr.io/metio/kurly/workloads/fider, ref: { tag: 2026.7.29 } }
---
