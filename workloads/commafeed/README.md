...
|---|---|---|
| `name` | `commafeed` | |
| `image` | `docker.io/athou/commafeed:7.3.0-h2` | the H2 (embedded-DB) variant |
...
spec: { interval: 12h, url: oci://ghcr.io/metio/kurly/workloads/commafeed, ref: { tag: 2026.7.29 } }
---
