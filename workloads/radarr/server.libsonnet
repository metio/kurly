...
// radarr — a Radarr server (a movie collection manager for Usenet and BitTorrent users, a fork of Sonarr for films). A plain composable kurly.http workload on the
...
//   kurly.list(radarr())
//
// Serves the web app and API on :7878 — compose an exposure onto it.
//
// MEDIA & DOWNLOADS: Radarr works against your media library and download-client
// directories. Mount them and point Radarr at them in its settings; compose the extra
